...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="flex gap-16 w-max marquee-trial items-center">
          {Array.from({ length: 8 }, (_, i) => (
            <div key={i} className="flex items-center gap-16">
              {["24/7 Customer Support", "12hr Fast Turnaround", "Trusted by 200+ Brands", "99.8% Satisfaction", "Free Trial Available"].map((text) => (
      ...
      <section className="relative overflow-hidden bg-[var(--bg)] py-12 md:py-16">
        <div className="relative h-[300px] md:h-[400px] overflow-hidden">
          {/* Background images grid */}
          <div className="absolute inset-0 grid grid-cols-4 gap-2 p-4 opacity-30">
            {heroSliderImages.slice(0, 4).map((src, i) => (
              <div key={`tf-${i}`} className="rounded-xl overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <StaggerReveal className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            {[
              ...
              { icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z", title: "Competitive Pricing", desc: "Transparent per-image pricing with volume discounts tailored to high-volume brands." },
              { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", title: "99.8% Satisfaction", desc: "Pixel-perfect quality guaranteed. Free revisions until you're completely satisfied." },
