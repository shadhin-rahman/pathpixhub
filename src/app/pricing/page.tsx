              ...
              <div className="mt-8 flex flex-col gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass-card border border-[rgb(var(--fg-rgb)/10%)] text-sm font-semibold text-[rgb(var(--fg-rgb)/70%)] hover:border-[rgb(143_209_2_/_50%)] hover:text-[rgb(143_209_2)] hover:shadow-md transition-all duration-300"
                  >
