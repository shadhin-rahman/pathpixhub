      ...
      <AnimatePresence mode="wait">
        {activeTab === "per-image" ? (
          ...
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            {/* Subscription: Billing Toggle + Currency */}
            ...
            {/* Subscription: Customer Protection */}
            <section className="py-20 bg-[var(--bg-alt)]">
              <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-12">
                  <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[rgb(var(--accent-500)/10%)] text-[rgb(var(--accent-400))] text-sm font-bold mb-4 border border-[rgb(var(--accent-500)/15%)]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    <motion.div key={i}
                      ...
                      className="rounded-2xl border-2 border-[rgb(var(--fg-rgb)/8%)] bg-[var(--bg)] p-6 hover:shadow-lg hover:-translate-y-1 transition-all"
                    >
