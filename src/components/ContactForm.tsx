      ...
      <div className="relative max-w-6xl mx-auto">
                ...
                {orderedKeys.length === 0 ? (
                  ...
                  <div className="mt-6 space-y-3">
                    ...
                    <div className="pt-4 mt-4 border-t border-[rgb(var(--fg-rgb)/10%)] space-y-2">
                      ...
                      {discountApplies && <div className="flex justify-between text-sm text-[rgb(143_209_2)]"><span>Volume discount</span><span>−${discountAmount.toFixed(2)}</span></div>}
              ...
              <div className="glass-card rounded-[2rem] p-8 border-[rgb(var(--fg-rgb)/10%)]">
                ...
                <div className="mt-6 space-y-3">
                  <a href="https://wa.me/8801723735896" target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-3 p-3 rounded-xl glass-card border border-[rgb(var(--fg-rgb)/8%)] hover:border-[rgb(143_209_2_/_50%)] transition-all text-sm text-[rgb(var(--fg-rgb)/70%)] hover:text-[rgb(143_209_2)]">
        ...
        {submitStatus === "success" && (
          <div className="glass-card rounded-[2rem] p-10 border-[rgb(var(--fg-rgb)/10%)] text-center">
            <div className="w-16 h-16 rounded-full bg-[rgb(143_209_2_/_12%)] flex items-center justify-center mx-auto mb-6">
            ...
            <p className="mt-4 text-[rgb(var(--fg-rgb)/55%)] leading-relaxed">
              Thank you for reaching out! We&apos;ve received your {wantsQuote ? "quote request" : "message"} and will get back to you with a custom quote within <span className="font-bold text-[rgb(143_209_2)]">45 minutes</span>.
            </p>
