    ...
    <nav className="fixed top-0 left-0 w-full z-50 py-4 md:py-6">
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-3 pr-4 md:pr-10">
          ...
          <Link
            href="/contact"
            className="px-8 py-4 rounded-full bg-[#a855f7] text-white font-black hover:bg-[rgb(var(--accent-500))] hover:text-[rgb(var(--accent-contrast))] transition-all duration-300 text-xs uppercase tracking-[0.4em] whitespace-nowrap"
          >
            Let's Talk
          </Link>
          <button
        ...
        <div className="md:hidden flex items-center gap-1.5 pr-4">
          ...
          <Link
            href="/contact"
            className="px-3 py-2.5 rounded-full bg-[#a855f7] text-white font-black hover:bg-[rgb(var(--accent-500))] hover:text-[rgb(var(--accent-contrast))] transition-all duration-300 text-[10px] uppercase tracking-[0.2em] whitespace-nowrap"
          >
            Let's Talk
          </Link>
          <button
